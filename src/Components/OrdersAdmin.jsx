...
export default function OrdersAdmin() {
  ...
  return (
    <section>
      <div dir={currentLang === "ar" ? "rtl" : "ltr"} className={`${toggle ? "visible" : "invisible"} transition bg-[#00000096] fixed w-full h-full top-0 left-0 z-40`}></div>
      <div className={`
        ...
        <form
          ...
          <div className="mb-4 last:mb-0">
            <select
              className="px-4 py-3 rounded-xl w-full outline-none bg-white"
              id="order"
              name="statusOrder"
              value={statusOrder}
            ...
            >
              ...
              <option value="received">{t("dashboard.received")}</option>
            </select>
          </div>
